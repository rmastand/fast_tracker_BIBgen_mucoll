# https://github.com/HEPML-AnomalyDetection/CATHODE/blob/LaCATHODE/density_estimator.py
...
class DE_MAF_RQS(DensityEstimator):
    name = "MAF_RQS"
    ...
    def build_block(self, i, modules, params):
        ...
        modules += [
            fnn.MADEwithRQS(self.num_inputs, params['num_hidden'],
                     params['num_cond_inputs'],
                     act=params['activation_function'],
                     pre_exp_tanh=params['pre_exp_tanh'],
...
class DE_Coupling(DensityEstimator):
    name = "COUPLING"
    ...
    def build_block(self, i, modules, params):
        ...
        modules += [
            fnn.CouplingLayerBlock(self.num_inputs, params['num_hidden'],
                     params['num_cond_inputs'],
                     s_act=params['activation_function'],
                     t_act=params['activation_function'],
                    ),
            ]
        if params['batch_norm']:
            modules += [fnn.BatchNormFlow(self.num_inputs,
...
class DE_Coupling_RQS(DensityEstimator):
    name = "COUPLING_RQS"
    ...
    def build_block(self, i, modules, params):
        ...
        modules += [
            fnn.CouplingLayerBlock_RQS(self.num_inputs, params['num_hidden'],
                     params['num_cond_inputs'],
                     act=params['activation_function'],
                     num_RQS_bins=params['num_bins'],
                    ),
            ]
        if params['batch_norm']:
            modules += [fnn.BatchNormFlow(self.num_inputs,
