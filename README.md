...
The next set of scripts need to be run on a machine with the [`MuonColliderSoft`](https://github.com/MuonColliderSoft/) image available. Details of how to access the image are [here](https://mcd-wiki.web.cern.ch/software/tutorials/fermilab2024/). The scripts in this repository use version 2.11.
...
- `SCRATCH_DIR`: path where `MuonColliderSoft` is installed
